                ...
                <Col lg={4}>
                    <Card>
                        <CardBody>
                            ...
                            <h4 className="card-title mb-4">Notification</h4>
                            ...
                            <SimpleBar style={{ maxHeight: "330px" }}>
                                <ul className="list-unstyled activity-wid">
                                    <li className="activity-list">
                                        ...
                                        <div>
                                            <div>
                                                <h5 className="font-size-13">28 March, 2023 <small className="text-muted">12:07 am</small></h5>
                                            </div>

                                            <div>
                                                <p className="text-muted mb-0">Status thanh toasn</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li className="activity-list">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <p className="text-muted mb-0">Công ty A vừa add thêm sản phẩm</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li className="activity-list">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <p className="text-muted mb-0">Nhắc nhở hoàn thành thanh toán</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li className="activity-list">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <p className="text-muted mb-0">Bạn có một email mới</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li className="activity-list">
                                        ...
                                        <div>
                                            <div>
                                                <h5 className="font-size-13">07 Apr, 2023 <small className="text-muted">12:47 pm</small></h5>
                                            </div>

                                            <div>
                                                <p className="text-muted mb-0">Một lịch trình được cập nhật</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li className="activity-list">
                                        ...
                                        <div>
                                            <div>
                                                <h5 className="font-size-13">05 Apr, 2023 <small className="text-muted">03:09 pm</small></h5>
                                            </div>
