                ...
                <Col lg={4}>
                    <Card>
                        <CardBody>
                            ...
                            <h4 className="card-title mb-3">Subsidiary Revenue</h4>
                                    ...
                                    <Table hover className=" mb-0 table-centered table-nowrap">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="font-size-14 mb-0">Company A</h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="font-size-14 mb-0">Company B</h5>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 className="font-size-14 mb-0">Company C</h5>
                                                </td>
